...
End-to-end use case testing against the real UI, with design quality comparison against Tailwind UI Catalyst demo.
...
├── specs/
│   ├── 00-catalyst-capture.spec # Catalyst demo reference screenshots
│   ├── 01-home-page.spec      # UC-01 through UC-17
│   └── ...
├── screenshots/
│   ├── bush/                  # Auto-captured during test runs
│   ├── catalyst/              # Reference screenshots (manual + auto)
...
2. Compare against `bp/screenshots/catalyst/` reference images
