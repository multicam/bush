...
import { Video, FolderOpen, Share2, Zap, Shield, MessageCircle, Loader2 } from "lucide-react";
      ...
      <header className="sticky top-0 z-sticky bg-surface-1 border-b border-border-default">
        <div className="w-full max-w-5xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-6">
            <a href="#features" className="text-sm text-secondary no-underline transition-colors hover:text-primary">
              Features
            </a>
            <a href="#pricing" className="text-sm text-secondary no-underline transition-colors hover:text-primary">
              Pricing
            </a>
            <a href="/login" className="text-sm font-medium text-secondary no-underline transition-colors hover:text-primary">
              Sign In
            </a>
        ...
        <section id="features" className="py-16 bg-surface-1">
          <div className="w-full max-w-5xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="p-6 bg-surface-2 border border-border-default rounded-md text-center">
                <FolderOpen className="w-10 h-10 mx-auto mb-4 text-accent" />
              ...
              <div className="p-6 bg-surface-2 border border-border-default rounded-md text-center">
                <Shield className="w-10 h-10 mx-auto mb-4 text-accent" />
              ...
              <div className="p-6 bg-surface-2 border border-border-default rounded-md text-center">
                ...
                <h3 className="text-base font-semibold text-primary m-0 mb-2">Real-time Comments</h3>
                <p className="text-sm text-secondary m-0 leading-relaxed">
      ...
      <footer className="py-8 bg-surface-2 border-t border-border-default">
        <div className="w-full max-w-5xl mx-auto px-6 flex items-center justify-between">
          ...
          <div className="flex gap-6">
            <a href="/privacy" className="text-sm text-secondary no-underline transition-colors hover:text-primary">
              Privacy
            </a>
            <a href="/terms" className="text-sm text-secondary no-underline transition-colors hover:text-primary">
              Terms
            </a>
            <a href="/contact" className="text-sm text-secondary no-underline transition-colors hover:text-primary">
              Contact
            </a>
          </div>
        </div>
