# Frame.io - Complete Atomic Feature Specifications

## Summary
This document contains an exhaustive breakdown of ALL atomic features extracted from the Frame.io platform, help documentation, and developer API.
...
|------|-------------|--------|
| Free | Basic use | 2 members, 2GB, 2 projects |
| Pro | Professional | 5 members, 2TB, unlimited projects |
| Team | Teams | 15 members, 3TB, unlimited projects |
| Enterprise | Multiple teams | Custom members/storage |
| Enterprise Prime | Enterprise + | Storage Connect, Secure Sharing, DRM, Forensic Watermarking |
...
- SAML2-based SSO (Enterprise)
- Adobe ID integration
- Two-factor authentication (2FA)
- Mandatory 2FA (Enterprise setting)
...
- Multiple workspaces per account (Enterprise)
...
#### Static Watermarking (Pro+)
- Text overlay
- Logo overlay
- Custom position
- Opacity control

#### Session-Based Watermarking (Enterprise Prime)
- Viewer email
- Viewer name
- IP address
- Geolocation
...
#### Forensic Watermarking (Enterprise Prime)
- Invisible unique identifiers
- Trace to specific viewer
- Trace to specific session
- Anti-screen-capture

### 15.3 Digital Rights Management (Enterprise Prime)
- Block screenshots
...
### 21.2 Access Groups (Beta)
- Organize members into groups
- Faster bulk invites
- Group-based permissions
- Admin Console sync

### 21.3 Admin Console Integration
- User management via Adobe Admin Console
- Role assignment
- User group syncing
...
*Generated from comprehensive analysis of frame.io, help.frame.io, and developer.frame.io*
