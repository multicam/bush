# Frame.io Complete Support & Documentation Reference

## Overview
This document is a comprehensive reference extracted from the Frame.io V4 Knowledge Center (help.frame.io), covering all product features, workflows, and technical specifications.
...
| Pro | $15/mo | 5 | 2TB + 2TB/member | Static watermarking, Custom branding |
| Team | $25/mo | 15 | 3TB + 2TB/member | Internal comments, Restricted projects |
| Enterprise | Custom | Unlimited | Custom | SSO, Session watermarking, Storage Connect |
| Enterprise Prime | Custom | Unlimited | Custom | DRM, Forensic watermarking, Secure sharing |
...
| Apple ID | All plans |
| Adobe ID | All plans |
| SAML2 SSO | Enterprise |
| Mandatory 2FA | Enterprise (configurable) |
...
- Multiple private Workspaces (Enterprise)
...
| Secure | Specific email invites | Enterprise Prime |
...
## 14.2 Storage Connect (Enterprise)

- Connect own AWS S3 bucket
- Primary bucket (read/write)
- Additional read-only buckets
- Frame.io stores proxies separately
- API asset registration

## 14.3 Asset Lifecycle Management (Enterprise)

| Setting | Options |
|---------|---------|
| Default Duration | 30, 60, 90 days |
| Custom Duration | Any value |
| None | Disabled |
| Workspace Override | Per-workspace policy |
| Project Override | Per-project toggle |
...
### Static Watermark (Pro+)
- One custom text block
- Position adjustment
- Opacity slider
- Rotation slider
- Size/color options
- Scroll effect
- Shadow option
- Unlimited templates (Enterprise)
- One template (Team/Pro)

### Session-Based Watermark (Enterprise Prime)
| Field | Description |
|-------|-------------|
| Viewer Name | User's display name |
| Viewer Email | User's email address |
| IP Address | Viewer's IP |
| Date/Time | Viewing timestamp |
| Geolocation | Approximate location |
| Share Name | Name of share |
| Share Creator | Who created share |
| Custom Text | Freeform text |

### Watermark Priority
Account → Workspace → Share

### Watermark Settings
- Require on internal assets
- Require on shares
- Role-based application
- Override by Owner/Admin

## 15.3 Forensic Watermarking (Enterprise Prime)

- Invisible unique identifiers
- Trace to specific viewer
- Trace to specific session
- Anti-screen-capture
- Real-time transcoding

## 15.4 Digital Rights Management (Enterprise Prime)
...
## 22.1 Multi-Workspace

- Separate private workspaces
- Per-client isolation
- Department separation
- Per-production workspaces

## 22.2 Access Groups (Beta)
...
## 23.1 Contact Methods

| Plan | Methods |
|------|---------|
| Free | Knowledge base, Community |
| Pro | Knowledge base, In-app chat |
| Team | Knowledge base, In-app chat, Email |
| Enterprise | All + Priority support, Dedicated team |
...
- Question mark icon (lower-left)
- Direct communication with support

---

*Document generated from Frame.io V4 Knowledge Center*
*Source: help.frame.io*
*Last updated: 2025*
